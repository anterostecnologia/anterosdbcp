...
public class TestMBean
{
   ...
   public void testMBeanRegistration() {
      ...
      new AnterosDBCPDataSource(config).close();
   }
   ...
   public void testMBeanReporting() throws SQLException, InterruptedException, MalformedObjectNameException {
      ...
      try (AnterosDBCPDataSource ds = new AnterosDBCPDataSource(config)) {
         ...
         ObjectName poolName = new ObjectName("br.com.anteros.dbcp:type=Pool (testMBeanReporting)");
         AnterosDBCPPoolMXBean hikariPoolMXBean = JMX.newMXBeanProxy(mBeanServer, poolName, AnterosDBCPPoolMXBean.class);
   ...
   public void testMBeanChange() {
      ...
      try (AnterosDBCPDataSource ds = new AnterosDBCPDataSource(config)) {
         AnterosDBCPConfigMXBean hikariConfigMXBean = ds.getAnterosDBCPConfigMXBean();
