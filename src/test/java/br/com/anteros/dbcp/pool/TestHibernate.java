...
import br.com.anteros.dbcp.hibernate.AnterosDBCPConnectionProvider;
...
public class TestHibernate
{
   ...
   {
      AnterosDBCPConnectionProvider provider = new AnterosDBCPConnectionProvider();
      ...
      assertNotNull(provider.unwrap(AnterosDBCPConnectionProvider.class));
