...
public class TestPropertySetter
{
   ...
   public void testProperty1() throws Exception
   {
      ...
      AnterosDBCPConfig config = new AnterosDBCPConfig(propfile1);
      config.validate();
   ...
   public void testProperty2() throws Exception
   {
      ...
      AnterosDBCPConfig config = new AnterosDBCPConfig(propfile2);
      config.validate();
   ...
   public void testPropertyUpperCase() throws Exception
   {
      ...
      AnterosDBCPConfig config = new AnterosDBCPConfig(propfile3);
      config.validate();
   ...
   {
      Set<String> propertyNames = PropertyElf.getPropertyNames(AnterosDBCPConfig.class);
   ...
   public void testSetNonExistantPropertyName() throws Exception
   {
      try {
         ...
         PropertyElf.setTargetFromProperties(new AnterosDBCPConfig(), props);
         fail();
      }
