...
public class ConnectionPoolSizeVsThreadsTest {
   ...
   private static final Logger LOGGER =  LoggerProvider.getInstance().getLogger(ConnectionPoolSizeVsThreadsTest.class.getName());
   ...
   private Counts testPoolSize(final int minIdle, final int maxPoolSize, final int threadCount,
      ...
      final AnterosDBCPConfig config = newAnterosDBCPConfig();
   ...
   private static class Counts {
      ...
      void updateMaxCounts(final AnterosDBCPPool pool) {
