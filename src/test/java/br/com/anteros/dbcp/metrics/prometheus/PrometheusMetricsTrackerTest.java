...
public class PrometheusMetricsTrackerTest
{
   ...
   {
      AnterosDBCPConfig configFirstPool = newAnterosDBCPConfig();
      ...
      AnterosDBCPConfig configSecondPool = newAnterosDBCPConfig();
      ...
      try (AnterosDBCPDataSource ignoredFirstPool = new AnterosDBCPDataSource(configFirstPool)) {
         assertThat(defaultCollectorRegistry.getSampleValue(
            "hikaricp_connection_timeout_total", LABEL_NAMES, labelValuesFirstPool),
            is(0.0));

         try (AnterosDBCPDataSource ignoredSecondPool = new AnterosDBCPDataSource(configSecondPool)) {
            assertThat(defaultCollectorRegistry.getSampleValue(
