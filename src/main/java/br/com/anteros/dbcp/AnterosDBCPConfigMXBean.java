...
/**
 * The javax.management MBean for a AnterosDBCP pool configuration.
 *
 * @author Brett Wooldridge
 */
public interface AnterosDBCPConfigMXBean
{
   /**
    ...
    * including both idle and in-use connections. If the idle connections dip below this value, AnterosDBCPCP will
