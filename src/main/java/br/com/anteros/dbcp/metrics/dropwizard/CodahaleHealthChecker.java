...
public final class CodahaleHealthChecker
{
    ...
    */
   public static void registerHealthChecks(final AnterosDBCPPool pool, final AnterosDBCPConfig hikariConfig, final HealthCheckRegistry registry)
   {
   ...
   {
      private final AnterosDBCPPool pool;
      private final long checkTimeoutMs;

      ConnectivityHealthCheck(final AnterosDBCPPool pool, final long checkTimeoutMs)
      {
         this.pool = pool;
