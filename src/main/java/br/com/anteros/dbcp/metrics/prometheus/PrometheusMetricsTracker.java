...
import br.com.anteros.dbcp.metrics.prometheus.PrometheusMetricsTrackerFactory.RegistrationStatus;
...
class PrometheusMetricsTracker implements IMetricsTracker
{
   ...
   private final AnterosDBCPCollector hikariCPCollector;
   ...
   PrometheusMetricsTracker(String poolName, CollectorRegistry collectorRegistry, AnterosDBCPCollector hikariCPCollector)
   {
