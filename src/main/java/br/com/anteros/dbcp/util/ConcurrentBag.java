...
import static br.com.anteros.dbcp.util.ClockSource.elapsedNanos;
...
import static br.com.anteros.dbcp.util.ConcurrentBag.IConcurrentBagEntry.STATE_REMOVED;
import static br.com.anteros.dbcp.util.ConcurrentBag.IConcurrentBagEntry.STATE_RESERVED;
...
import br.com.anteros.dbcp.util.ConcurrentBag.IConcurrentBagEntry;
...
{
   private static final Logger LOGGER = LoggerProvider.getInstance().getLogger(ConcurrentBag.class.getName());
   ...
   {
      try {
         if (System.getProperty("br.com.anteros.dbcp.useWeakReferences") != null) {   // undocumented manual override of WeakReference behavior
            return Boolean.getBoolean("br.com.anteros.dbcp.useWeakReferences");
         }
