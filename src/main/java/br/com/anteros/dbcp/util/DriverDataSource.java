...
{
   private static final Logger LOGGER = LoggerProvider.getInstance().getLogger(DriverDataSource.class.getName());
      ...
      if (driverClassName != null) {
         ...
         if (driver == null) {
            ...
            try {
               ...
               LOGGER.debug("Failed to load driver class {} from AnterosDBCPConfig class classloader {}", driverClassName, this.getClass().getClassLoader());
            }
