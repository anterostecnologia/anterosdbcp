...
public final class PropertyElf
{
   ...
   public static void setTargetFromProperties(final Object target, final Properties properties)
   {
      ...
      properties.forEach((key, value) -> {
         if (target instanceof AnterosDBCPConfig && key.toString().startsWith("dataSource.")) {
            ((AnterosDBCPConfig) target).addDataSourceProperty(key.toString().substring("dataSource.".length()), value);
         }
         else {
