...
/**
 * Utility class to map Hibernate properties to AnterosDBCPCP configuration properties.
 *
...
public class AnterosDBCPConfigurationUtil
{
   ...
   /**
    * Create/load a AnterosDBCPConfig from Hibernate properties.
    *
    * @param props a map of Hibernate properties
    * @return a AnterosDBCPConfig
    */
