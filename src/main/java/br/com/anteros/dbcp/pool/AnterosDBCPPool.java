 ...
 * pooling behavior for AnterosDBCPCP.
 *
...
public final class AnterosDBCPPool extends PoolBase implements AnterosDBCPPoolMXBean, IBagStateListener
{
   ...
   private final long aliveBypassWindowMs = Long.getLong("br.com.anteros.dbcp.aliveBypassWindowMs", MILLISECONDS.toMillis(500));
   private final long housekeepingPeriodMs = Long.getLong("br.com.anteros.dbcp.housekeeping.periodMs", SECONDS.toMillis(30));
   ...
   /**
    * Set a metrics registry to be used when registering metrics collectors.  The AnterosDBCPDataSource prevents this
    ...
    * through {@link br.com.anteros.dbcp.AnterosDBCPDataSource#evictConnection(Connection)} then {@code owner} is {@code true}.
    *
    ...
    * to be used in the {@link AnterosDBCPConfig}, then we use that.  If no Executor was specified (typical), then create
