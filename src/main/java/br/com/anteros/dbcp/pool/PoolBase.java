...
import static br.com.anteros.dbcp.pool.ProxyConnection.*;
import static br.com.anteros.dbcp.util.ClockSource.*;
...
abstract class PoolBase
{
   ...
   public final AnterosDBCPConfig config;
   ...
   PoolBase(final AnterosDBCPConfig config)
   {
      this.config = config;
   ...
   /**
    * Register MBeans for AnterosDBCPConfig and AnterosDBCPPool.
    *
    * @param hikariPool a AnterosDBCPPool instance
    */
   void handleMBeans(final AnterosDBCPPool hikariPool, final boolean register)
   {
      ...
      try {
         ...
         final ObjectName beanConfigName = new ObjectName("br.com.anteros.dbcp:type=PoolConfig (" + poolName + ")");
         final ObjectName beanPoolName = new ObjectName("br.com.anteros.dbcp:type=Pool (" + poolName + ")");
         if (register) {
