...
import br.com.anteros.dbcp.util.FastList;
...
{
   private static final Logger LOGGER = LoggerProvider.getInstance().getLogger(PoolEntry.class.getName());
   ...
   private final AnterosDBCPPool hikariPool;
   ...
   PoolEntry(final Connection connection, final PoolBase pool, final boolean isReadOnly, final boolean isAutoCommit)
   {
      ...
      this.hikariPool = (AnterosDBCPPool) pool;
